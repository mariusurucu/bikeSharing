    ...
    <section class="menu cid-qTkzRZLJNu" once="menu" id="menu1-0">
        ...
        <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-secondary-outline display-4" href="home.jsp"><span class="mbri-home mbr-iconfont mbr-iconfont-btn"></span>&nbsp;Home</a></div>
            </div>
        </nav>
    </section>
        ...
        <div class="container align-center">
            <div class="row justify-content-md-center">
                <div class="mbr-white col-md-10">
                    <h1 align="center" class="mod-title">Oferte:</h1>

                    <br/>

                    <form action="userLogin.html" class="mod-table-mid" method="post">
                        <div class="table-responsive">
                            <table border="1" align="center">
                                <tr class="mod-table-head">
                                    ...
                                    <td><b>Pret</b></td>
                                    <td><b>Descriere</b></td>
                                    <td><b>Detalii aditionale</b></td>                
                                </tr>
                                <%
                                    jb.connect();
                                    ResultSet rs = jb.vedeTabela("oferte");
                                    int x;
                                    while (rs.next()) {
                                        x = rs.getInt("id");
                                        ResultSet rs2 = jb.intoarceLinieDupaId("bikes", "id", rs.getInt("titlu"));
                                        if(rs2.next()){

                                %>
                                <tr class="mod-table-line">
                                    <td><input type="checkbox" name="primarykey" value="<%= x%>" /></td>
                                    <td><%= rs2.getString("firma") + " " + rs2.getString("model")%></td>
                                    <td><%= rs.getString("pret") + " " + rs.getString("moneda")%></td>
                                    <td><%= rs.getString("detalii")%></td>
                                    <td><%= rs.getString("constrangeri")%></td>
                        ...
                        <p align="center">
                            <input type="submit" class="mod-button btn btn-sm display-4" value="Intra in cont">
                        </p>
                    </form>
                    <%
                        rs.close();
